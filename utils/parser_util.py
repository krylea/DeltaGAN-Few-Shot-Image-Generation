...
def get_args():
    ...
    parser.add_argument('--lr_g', nargs="?", type=float, default=1e-4)
    ...
    parser.add_argument('--is_attention', nargs="?", type=int, default=0)
    parser.add_argument('--connection_layers', nargs="?", type=int, default=0)
